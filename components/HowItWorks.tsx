    ...
    <Section>
      ...
      <div className="flex flex-col md:flex-row items-center md:items-start justify-center gap-12 md:gap-0">
        ...
        <div className="flex-1 flex flex-col items-center text-center relative px-4 w-full md:w-auto">
          ...
          <div className="absolute -top-20 left-1/2 -translate-x-1/2 w-64 flex flex-col items-center z-20">
            <div className="flex flex-wrap justify-center gap-2 mb-1">
              {["Emails", "Transcripts", "CRM Data"].map((tag, i) => (
          ...
          <h3 className="font-sans font-bold text-xl mb-2">1. Ingest</h3>
          <p className="text-gray-600 text-sm max-w-xs">Soots connects to your ecosystem and absorbs every unstructured interaction.</p>
        </div>
        ...
        <div className="flex-1 flex flex-col items-center text-center relative px-4 w-full md:w-auto">
          ...
          <h3 className="font-sans font-bold text-xl mb-2 text-blueprint-blue">2. Map</h3>
          <p className="text-gray-600 text-sm max-w-xs">Our model identifies relationships, commitments, and risks. Links objections to delays.</p>
        </div>
        ...
        <div className="flex-1 flex flex-col items-center text-center relative px-4 w-full md:w-auto">
          ...
          <h3 className="font-sans font-bold text-xl mb-2">3. Execute</h3>
          <p className="text-gray-600 text-sm max-w-xs">Auto-generated SOWs, Project Plans, and Risk Registers.</p>
        </div>
